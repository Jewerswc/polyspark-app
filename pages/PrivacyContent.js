...
export default function PrivacyContent() {
  ...
  return (
    ...
    <section className={styles.tpSection}>
      <h2>Introduction</h2>
      <p>This Privacy Policy explains how Polyspark (“we”, “us” or “our”) collects, uses, discloses and protects information when you use our website and services, including interactions with our AI agents. By engaging with our service, you consent to the practices described herein.</p>
    </section>
